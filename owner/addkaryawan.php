                ...
                <div class="form-card">
                    ...
                    <form action="../backend/process/tambah_karyawan.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="notlpn" name="notlpn" placeholder="08123456789">
                        </div>
                        <div class="form-group">
                            <label for="alamat">Alamat</label>
                            <textarea id="alamat" name="alamat" rows="4" placeholder="Masukkan alamat" style="resize: vertical;"></textarea>
                        </div>
