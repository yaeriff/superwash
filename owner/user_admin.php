...
$data_admin = mysqli_query($koneksi, "SELECT * FROM user WHERE role='admin' ORDER BY user_id DESC");
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Kelola Admin - Super Wash</title>
...
<body>
    <div class="container">
        ...
        <a href="addadmin.php" class="btn"><i class="fas fa-plus"></i> Tambah Admin</a>
            ...
            <tbody>
                <?php while($row = mysqli_fetch_assoc($data_admin)): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editadmin.php?id=<?php echo $row['user_id']; ?>" class="btn btn-edit">Edit</a>
