...
$pesanan_hari_ini = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM pemesanan WHERE DATE(tanggal_pemesanan) = CURDATE()"));
$page = 'index';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Beranda - Super Wash Owner</title>
            ...
            <div class="content">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 40px;">
                    ...
                    <div style="background-color: white; padding: 25px; border-radius: 8px; border-left: 5px solid #e67e22; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>
                                <h4 style="margin: 0 0 10px 0; color: #666; font-size: 14px; font-weight: 500;">Pesanan Hari Ini</h4>
                                <p style="margin: 0; font-size: 28px; font-weight: 700; color: #1a253a;"><?php echo $pesanan_hari_ini; ?></p>
                            </div>
                            <i class="fa-solid fa-shopping-cart" style="font-size: 40px; color: #e67e22; opacity: 0.2;"></i>
                        </div>
                    </div>
                </div>
                <div style="background-color: white; padding: 25px; border-radius: 8px; border-left: 5px solid #ffd700; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                    <h3 style="color: #1a253a; margin-top: 0;">📊 Dashboard Owner</h3>
                    <p style="color: #666; line-height: 1.6; margin-bottom: 15px;">Kelola karyawan, pantau transaksi, dan lihat detail pesanan dari dashboard ini.</p>
