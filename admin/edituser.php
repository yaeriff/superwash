...
$user_id = $_GET['id'];
$data = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM user WHERE user_id='$user_id'"));
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Edit User - Super Wash</title>
...
<body>
    <div class="container">
        ...
        <form action="../backend/process/edit_user.php" method="POST">
